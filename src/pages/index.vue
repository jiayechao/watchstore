<template>
  <div class="main-wrap">
    <div class="banner">
      <el-carousel height="615px" arrow="never" :interval="3000">
    ...
    <div class="recommend">
      <div class="recommend-goods" v-for="(item, index) in recommendList" :key="index">
        <router-link class="goods-img fl" :style="{backgroundImage: 'url(' + item.imgUrl + ')'}"
                     :to="'/goods/'+item.itemBaseId"></router-link>
    ...
    <div class="goods-list">
      ...
      <div class="list-wrap">
        <router-link v-for="(item, index) in goodsList" :key="index" class="goods-item fl"
                     :to="'/goods/'+item.itemBaseId">
